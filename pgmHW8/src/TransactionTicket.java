...
public class TransactionTicket extends genTransactionTicket {
	...
	public TransactionTicket(int acctNum, String typeOfTransaction, Calendar dateOfTransaction, double amount, Calendar termOfCD,
	Calendar oldMaturityDate, Check check) {
		// TODO Auto-generated constructor stub
		super(acctNum, typeOfTransaction, dateOfTransaction,
		amount, termOfCD, oldMaturityDate, check);
	}
